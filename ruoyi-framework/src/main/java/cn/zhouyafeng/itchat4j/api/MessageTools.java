...
public class MessageTools {
	 ...
	 * @param toUserName
	 */
	private static void sendMsg(String text, String toUserName, Core core) {
		if (text == null) {
			return;
		}
	 ...
	 * @param id
	 */
	public static void sendMsgById(String text, String id,Core core) {
		if (text == null) {
			return;
		}
		sendMsg(text, id,core);
	}
	 ...
	 * @param nickName
	 */
	public static boolean sendMsgByNickName(String text, String nickName,Core core) {
		if (nickName != null) {
			String toUserName = WechatTools.getUserNameByNickName(nickName,core);
			if (toUserName != null) {
				webWxSendMsg(1, text, toUserName,core);
				return true;
			}
	 ...
	 * @param toUserName
	 */
	public static void webWxSendMsg(int msgType, String content, String toUserName, Core core) {
	 ...
	 * @return
	 */
	public static boolean sendPicMsgByNickName(String nickName, String filePath,Core core) {
		String toUserName = WechatTools.getUserNameByNickName(nickName,core);
		if (toUserName != null) {
	 ...
	 * @return
	 */
	public static boolean sendPicMsgByUserId(String userId, String filePath,Core core) {
		JSONObject responseObj = webWxUploadMedia(filePath,core);
		if (responseObj != null) {
			String mediaId = responseObj.getString("MediaId");
			if (mediaId != null) {
				return webWxSendMsgImg(userId, mediaId,core);
			}
		}
		return false;
	}
	 ...
	 * @return
	 */
	private static boolean webWxSendMsgImg(String userId, String mediaId,Core core) {
	 ...
	 * @return
	 */
	public static boolean sendFileMsgByUserId(String userId, String filePath,Core core) {
		...
		return webWxSendAppMsg(userId, data,core);
	}
	 ...
	 * @return
	 */
	public static boolean sendFileMsgByNickName(String nickName, String filePath,Core core) {
		String toUserName = WechatTools.getUserNameByNickName(nickName,core);
		if (toUserName != null) {
	 ...
	 * @return
	 */
	private static boolean webWxSendAppMsg(String userId, Map<String, String> data, Core core) {
	 ...
	 *            true 接受 false 拒绝
	 */
	public static void addFriend(BaseMsg msg, boolean accept,Core core) {
		if (!accept) { // 不添加
			return;
		}
