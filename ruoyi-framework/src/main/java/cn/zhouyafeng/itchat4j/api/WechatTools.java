...
public class WechatTools {
	 ...
	 * @param toUserName
	 */
	public static void sendMsgByUserName(String msg, String toUserName,Core core) {
	 ...
	 * @return
	 */
	public static String getUserNameByNickName(String nickName,Core core) {
	 ...
	 * 根据群名返回群id
	 */
	public static String getGroupIdByNickName(String nickName,Core core){
		for (JSONObject o :getGroupList(core)) {
			if (o.getString("NickName").equals(nickName)) {
				return o.getString("UserName");
			}
		}
	 ...
	 * @return
	 */
	public static JSONArray getMemberListByGroupId(String groupId,Core core) {
	 ...
	 * @param remName
	 */
	public static void remarkNameByNickName(String nickName, String remName,Core core) {
