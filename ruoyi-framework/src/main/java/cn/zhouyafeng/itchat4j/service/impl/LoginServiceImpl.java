...
public class LoginServiceImpl implements ILoginService {
	...
	@Override
	public boolean login(Core core) {
	...
	@Override
	public String getUuid(Core core) {
		// 组装参数和URL
		List<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();
	...
	@Override
	public HttpEntity getQR(Core core) {
		String qrUrl = URLEnum.QRCODE_URL.getUrl() + core.getUuid();
		MyHttpClient httpClient = core.getMyHttpClient();
        return httpClient.doGet(qrUrl, null, true, null);
//		try {
...
//		}
	...
	@Override
	public boolean webWxInit(Core core) {
		core.setAlive(true);
	...
	@Override
	public void wxStatusNotify(Core core) {
		// 组装请求URL和参数
	...
	@Override
	public void startReceiving(Core core) {
		core.setAlive(true);
	...
	@Override
	public void webWxGetContact(Core core) {
	...
	@Override
	public void WebWxBatchGetContact(Core core) {
